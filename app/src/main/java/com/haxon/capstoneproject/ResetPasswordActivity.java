...
public class ResetPasswordActivity extends AppCompatActivity {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()){
                        ...
                        if (dataSnapshot.hasChild("Security Questions")){
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "Questions are not set!!", Toast.LENGTH_SHORT).show();
                        }

                    }else{
                        Toast.makeText(ResetPasswordActivity.this, "User with this number does not exist!!", Toast.LENGTH_SHORT).show();
                    }
    ...
    //Adding the security to the database by creating a database reference and making child in the user.
    ...
    //display the answers on the editText means retrieve the information from the database and display.
